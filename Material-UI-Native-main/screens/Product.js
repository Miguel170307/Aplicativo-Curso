              ...
              <Block style={{ paddingHorizontal: theme.SIZES.BASE, paddingTop: theme.SIZES.BASE * 2 }}>
                ...
                <Block row space="between">
                  <Block row>
                    ...
                    <Block>
                      <Text size={14}>Cleitin Sabugo</Text>
                      <Text size={14} muted>sou clubista </Text>
                    </Block>
                  </Block>
